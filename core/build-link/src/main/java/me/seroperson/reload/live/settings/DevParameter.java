 ...
 *
 * <p>This class encapsulates a parameter that can be configured through multiple sources
 * with a defined precedence order. It supports type-safe parsing and string conversion
 * of parameter values.
 *
...
public class DevParameter<T> {
   ...
   * <li>Plugin settings overrides</li>
