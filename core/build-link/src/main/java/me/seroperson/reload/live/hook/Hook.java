 ...
 *
 * <p>Hooks provide a way to execute custom logic at specific points during application startup or
...
public interface Hook {
   ...
   *
   * <p>This method is typically used to check if required dependencies or conditions are met before
