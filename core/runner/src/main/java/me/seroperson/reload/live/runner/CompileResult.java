 ...
 * <ul>
 * <li>{@link CompileSuccess} - indicates successful compilation with resulting classpath</li>
 * <li>{@link CompileFailure} - indicates compilation failure with exception details</li>
 * </ul>
 */
public interface CompileResult {
     ...
     *
     * <p>
     * Contains the classpath entries that resulted from the compilation process. The classpath
     ...
     *
     * <p>
     * Contains the exception that caused the compilation to fail. This allows the caller to access
